...
public class MemoryMapper<A, B, C, D> extends Mapper<A, B, C, D> {
    ...
    public class MemoryMapContext extends Mapper.Context {
        ...
        public MemoryMapContext(final Mapper.Context context) throws IOException, InterruptedException {
            this.mapContextImpl = new MapContextImpl<A, B, C, D>(context.getConfiguration(), context.getTaskAttemptID() == null ? new TaskAttemptID() : context.getTaskAttemptID(), null, null, context.getOutputCommitter(), null, context.getInputSplit());
